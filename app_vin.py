...
logo_base64 = get_base64_logo("otsuka_im.png")  # Replace with your actual logo file
...
for key in ["result", "feedback", "user_query", "active", "pdf_bytes", "slide_bytes"]:
...
if user_query and st.button("💬 Get Recommendation"):
    with st.spinner("Finding the best products for you"):
        ...
        st.session_state.result = graph.invoke({"question": user_query})  # Your custom LLM invocation
...
if st.session_state.result:
    ...
    if st.session_state.active:
        st.markdown("---")
        st.subheader("Any changes aor feedback you would like to recommend")
