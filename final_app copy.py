...
# microphone
audio_main = mic_recorder(start_prompt="🎤", stop_prompt="⏹️", key="recorder_main")
...
user_query = st.text_input(
    ...
    key="text_query",
    # on_change=lambda: st.session_state.__setitem__("just_transcribed", False)
)
...
if st.session_state.result:
    ...
    if st.session_state.active:
        ...
        audio_fb = mic_recorder(start_prompt="🎤", stop_prompt="⏹️", key="recorder_fb")
        ...
        feedback_text = st.text_area(
            ...
            key="feedback_text",
            # on_change=lambda: st.session_state.__setitem__("just_transcribed_fb", False)
        )
